...
<body class="bg-light">
    ...
    <div class="container mt-4 mb-5">
        <h3 class="fw-bold text-secondary mb-3"><i class="fas fa-history"></i> Riwayat Aktivitas Pengguna</h3>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $q = mysqli_query($koneksi, "SELECT * FROM aktifitas ORDER BY id_aktifitas DESC");
                            while ($r = mysqli_fetch_assoc($q)) :
                            ?>
                            <tr>
                                <td class="text-center"><?= $no++; ?></td>
                                <td class="text-center"><?= $r['created_at']; ?></td>
                                <td class="text-center"><span class="badge bg-info text-dark"><?= htmlspecialchars($r['role']); ?></span></td>
                                <td><strong><?= htmlspecialchars($r['nama_user']); ?></strong></td>
