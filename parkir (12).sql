...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2026 at 10:04 AM
...
(16, 'BA 5487 PA', 'Mobil', 'awd qwerfgwer', 2),
(17, 'CA 1234 AW', 'Motor', 'a', 2);
...
(53, 1, 'User berhasil login', '2026-08-31 14:25:02'),
(54, 1, 'User berhasil login', '2026-08-31 14:39:15'),
(55, 2, 'User berhasil login', '2026-08-31 14:45:59'),
(56, 1, 'User berhasil login', '2026-08-31 14:47:56'),
(57, 2, 'User berhasil login', '2026-08-31 14:49:02'),
(58, 3, 'User berhasil login', '2026-08-31 14:49:50'),
(59, 2, 'User berhasil login', '2026-08-31 14:52:41'),
(60, 1, 'User berhasil login', '2026-08-31 14:55:36'),
(61, 2, 'User berhasil login', '2026-08-31 14:59:21');
...
(17, 16, '2026-08-31 14:46:43', '2026-08-31 09:47:36', 2, 5, 500005, 'keluar', 'sudah', 2, 5),
(18, 17, '2026-08-31 14:49:30', '2026-08-31 09:49:36', 1, 5, 10000, 'keluar', 'belum', 2, 5);
...
(106, 'aaaaaaaaaaaaaaaaaaaaaaaaa', 'q', 'q', 'owner', 0);
...
--
ALTER TABLE `tb_transaksi`
  MODIFY `id_parkir` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
